                        ...
                        <form method="post" action="{{ route('providers.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input-price" class="form-control form-control-alternative" placeholder="Name" value="{{ old('name') }}" required autofocus>
                                    {{-- @include('alerts.feedback', ['field' => 'price']) --}}
                                </div>
                                
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-price">Email</label>
                                    <input type="email" name="email" id="input-price" class="form-control form-control-alternative" placeholder="Email" value="{{ old('email') }}" >
                                    {{-- @include('alerts.feedback', ['field' => 'price']) --}}
                                </div>

                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-price">Phone</label>
                                    <input type="tel" name="phone" id="input-price" class="form-control form-control-alternative" placeholder="Phone" value="{{ old('phone') }}" required>
                                    {{-- @include('alerts.feedback', ['field' => 'price']) --}}
                                </div>
                                
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-price">Reference</label>
                                    <input type="text" name="reference" id="input-price" class="form-control form-control-alternative" placeholder="Reference" value="{{ old('reference') }}" >
                                    {{-- @include('alerts.feedback', ['field' => 'price']) --}}
                                </div>
