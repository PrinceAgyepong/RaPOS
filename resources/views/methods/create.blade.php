                        ...
                        <form method="post" action="{{ route('methods.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="description" id="input-description" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="other details (optional)" value="{{ old('description') }}">
